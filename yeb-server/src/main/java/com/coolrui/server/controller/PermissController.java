...
import com.coolrui.server.service.IRoleService;
...
/**
 * @Author: Coolrui
 * @Date: Created in 11:03 2021/3/31
 * @Description 权限组
 */
@Api(tags = "PermissController:权限组管理")
@RestController
...
public class PermissController {
    ...
    @GetMapping("/mid/{rid}")
    public List<Integer> getMindByRid(@PathVariable Integer rid) {
